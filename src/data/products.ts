...
// Legacy exports for backward compatibility (will be removed once all components are updated)
...
export const products: Product[] = [
  {
    ...
    description:
      "A comfortable and stylish white t-shirt made from 100% organic cotton. Perfect for everyday wear with a modern fit and excellent durability.",
    sizes: ["S", "M", "L", "XL"],
    colors: [
  ...
  },
  {
    ...
    description:
      "Natural face serum with hyaluronic acid and vitamin C. Hydrates skin, reduces fine lines, and brightens complexion.",
    rating: 4.9,
    reviews: 203,
    inStock: true,
    isNew: true,
